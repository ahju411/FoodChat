...
public class ManageReviewAdapter extends RecyclerView.Adapter<ManageReviewAdapter.ViewHolder> {
    ...
    public ManageReviewAdapter(){

    }

    @NonNull
    @Override
    public ManageReviewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //원하는 layout띄우기
    ...
    @Override
    public void onBindViewHolder(@NonNull ManageReviewAdapter.ViewHolder holder, int position) {
